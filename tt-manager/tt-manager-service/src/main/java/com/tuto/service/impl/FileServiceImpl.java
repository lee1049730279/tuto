...
import com.tuto.common.util.FtpUtil;
import com.tuto.common.util.IDUtils;
import com.tuto.service.FileService;
...
public class FileServiceImpl implements FileService {
    ...
    public Map<String, Object> uploadImages(MultipartFile upfile) {
        ...
        String address = "101.132.173.152";
        int port = 21;
        String username = "ftpuser";
        String password = "zhanglei123";
        String basePath = "/home/ftpuser/www/images/trip_picture";
