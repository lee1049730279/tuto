...
<head>
   ...
   <%--<div class="page_top" style="width:100%; height:60px; /*background:url(images/cii_j1nl032ib6m6aagvbpenoiqaacsiakpiquaazwe42.jpeg) no-repeat top center;*/" >
    ...
    </div><script>var d=new Date();var elk="P_INDEX";</script>--%>
            ...
            <div class="header_inner">
                ...
                <div class="tn_search_box">
                    <div id="tnSearchBox" class="clearfix">
                        <form id="route_search" name="route_search" method="post" onsubmit="return false;" action="http://s.tuniu.com/search_complex" target="_self">
                            <input type="hidden" value="马尔代夫" name="q" id="q"/>
                            <input type="hidden" value="4" name="st" id="st"/>
                            <input type="hidden" value="search_complex" id="from_action"  />
                            <input id="letter" type="hidden" value="hz" />
                            <div class="tn_s_select" id="typename">
                                ...
                                <div class="tn_search_bar">
                                    ...
                                    <div class="type_s" classify="2">自助游</div>
                                    <div class="type_s" classify="12">邮轮</div>
                                    <div class="type_s" classify="6">景点门票</div>
                            ...
                            <p class="tn_s_input">
                                <input type="text" id="keyword-input" value=马尔代夫 data="" data-cla=""  autocomplete="off" style="color: rgb(153, 153, 153);"/>
                            </p>
                            <div class="an_mo" liwithhan="搜索按钮">
                                <p class="tn_s_button" onclick="_gaq.push(['_trackEvent', '首页_hz','点击','搜索_放大镜___']);tuniuRecorder.push('3_3_1_1_1_2');"><button type="button" id="searchSub"></button></p>
                            </div>
                            <!-- <div id="check_route_hi"></div>
                             <div id="check_route_hi"></div>-->
                        </form>
                    </div>
                    <ul class="search_hot"> <li  class="an_mo first" m="点击_搜索框_初始层_搜索热搜词_1_三亚"><a onclick="_gaq.push(['_trackEvent', '首页_hz','点击','搜索_热搜词_1-三亚']);tuniuRecorder.push('3_3_1_1_2_1');" rel="nofollow" href=" http://s.tuniu.com/search_complex/whole-hz-0-%E4%B8%89%E4%BA%9A/">三亚</a></li><li  class="an_mo second" m="点击_搜索框_初始层_搜索热搜词_2_台湾"><a onclick="_gaq.push(['_trackEvent', '首页_hz','点击','搜索_热搜词_2-台湾']);tuniuRecorder.push('3_3_1_1_2_2');" rel="nofollow" href=" http://s.tuniu.com/search_complex/whole-hz-0-%E5%8F%B0%E6%B9%BE/">台湾</a></li><li class="last an_mo" m="点击_搜索框_初始层_搜索热搜词_3_日本"><a onclick="_gaq.push(['_trackEvent', '首页_hz','点击','搜索_热搜词_3-日本']);tuniuRecorder.push('3_3_1_1_2_3');" rel="nofollow" href=" http://s.tuniu.com/search_complex/whole-hz-0-%E6%97%A5%E6%9C%AC/">日本</a></li></ul>
                </div>
                <a class="search_advance" id="seniorSearch" onclick="_gaq.push(['_trackEvent', '首页_hz','点击','高级搜索_默认按钮__'])">高级搜索<i class="header_icon icon_arrow"></i></a>
            </div>
         </div>
     </div>
</div>