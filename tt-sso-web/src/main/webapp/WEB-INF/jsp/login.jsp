...
<%--<body>--%>
	<%--<!-- header -->--%>
	<%--<div class="header">--%>
		<%--<a href="http://www.e3mall.cn"><img src="${pageContext.request.contextPath}/images/logo.png" border="0"><span>欢迎登录</span></a>--%>
	<%--</div>--%>
	<%--<!-- login_main -->--%>
	<%--<div class="login_main clear">--%>
		<%--<div class="pic">--%>
			<%--<a href="http://www.e3mall.cn/html/activity/1472720729.html" target="_blank"><img src="${pageContext.request.contextPath}/images/06f42c372620f92b40da77a8b23cdf7f.png"></a>--%>
		<%--</div>--%>
		<%--<!-- login -->--%>
		<%--<div class="login">--%>
    ...
    <%--</div>--%>
		...
		<%----%>
						...
						<%--<span style="position: absolute; font-size: 14px; left: 5px; top: 9px;display:none;" class="sfbest_username_place">用户名</span>--%>
							<%--</span>--%>
...
<%--</div></form>--%>
	...
	<%--<div class="footer">--%>
		...
		<%--</span>--%>
		<%--<p>--%>
			<%--杭州途兔电子商务有限公司<br> 杭州市公安局顺义分局备案11011302000890号|<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">杭ICP备12011349号</a>|<a href="http://www.e3mall.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br> Copyright© 途兔--%>
			<%--e3mall.cn 版权所有<br>--%>
		<%--</p>--%>
	<%--</div>--%>
	<%--<!-- /footer -->--%>
